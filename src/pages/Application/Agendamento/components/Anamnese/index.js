...
import { rootURL as baseURL, nexoData } from '../../../../../services/api';
...
class Anamnese extends Component {
    ...
    try {
      ...
      const Estabelecimento = {
        ...
        Endereco: {
          ...
          Estado: unidade.cidade.estado_uf,
      ...
      await this.setState({ prescricao, modalPrescricao: true, showFloatMenu: false });
    } catch (err) {
  ...
  handleClickCancelarEdicao = () => {
    const { history, pacienteId, handleClose } = this.props;
        ...
        >
          <Container>
            <Dialog
              ...
              aria-describedby="alert-dialog-slide-description"
            >
              <DialogTitle id="alert-dialog-slide-title" style={{ alignSelf: 'center' }}>
                        ...
                        <ExpansionPanel key={item.id}>
                          <ExpansionPanelSummary expandIcon={<ExpandMoreIcon />}>
                            <Typography className={classes.heading}>
                              <strong>{`Revisão ${index + 1}/${revisoes.length}: `}</strong>
